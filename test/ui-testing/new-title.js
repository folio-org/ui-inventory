    ...
    describe('Login > Open module "Inventory" > Create new instance > Sort list by title > Confirm creation of new title > Logout', () => {
      ...
      it('should create new instance ', (done) => {
        nightmare
          ...
          .wait('#clickable-add-notes')
          .click('#clickable-add-notes')
          .wait(55)
          .wait('select[name="notes[0].instanceNoteTypeId"]')
          .type('select[name="notes[0].instanceNoteTypeId"]', 'Acc')
          .wait('input[name="notes[0].note"]')
          .insert('input[name="notes[0].note"]', notes[0])
          .click('#clickable-add-notes')
          .wait(55)
          .wait('select[name="notes[1].instanceNoteTypeId"]')
          .type('select[name="notes[1].instanceNoteTypeId"]', 'Action')
          .wait('input[name="notes[1].note"]')
          .insert('input[name="notes[1].note"]', notes[1])
          .click('#clickable-add-notes')
          .wait(55)
          .wait('select[name="notes[2].instanceNoteTypeId"]')
          .type('select[name="notes[2].instanceNoteTypeId"]', 'Awards')
