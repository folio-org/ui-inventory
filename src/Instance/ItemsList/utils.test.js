...
describe('item sort handlers', () => {
  ...
  it('should sort by enumeration, numerically ascending', () => {
    const list = [
      ...
      { barcode: 'u612', enumeration: 'beta' },         // beta
      { barcode: 'v612', enumeration: 'gamma' },        // gamma
    ];
  ...
  it('should sort by enumeration, alphabetically ascending', () => {
    const list = [
      { barcode: 'b612', enumeration: 'apple' },
      { barcode: 'b613', enumeration: 'banana' },
      { barcode: 'b615', enumeration: 'cherry' },
    ];
