...
describe('MoveHoldingContext', () => {
  ...
  describe('when "Move" button is clicked', () => {
    const clickMoveFlow = async () => {
      const { getByText, getByTestId, findByText } = renderMoveHoldingContext();
      ...
      await waitFor(() => {
        dropdownMoveBtn = within(holdingsAnnex).getByText('A journey through Europe Bildtontraeger high-speed lines European Commission, Directorate-General for Mobility and Transport');
