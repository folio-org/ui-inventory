...
/*
  Given
    @selectedLanguagesId an array of language codes corresponding to selected filters,
      e.g. ['eng', 'ger'],
    @intl a react-intl object
    @langs an array of language codes and counts of the number of records containing those languages
