...
const ViewSource = ({
  ...
  const isPrintHoldingsAvailable = isHoldingsRecord && (stripes.hasPerm('ui-quick-marc.quick-marc-holdings-editor.all') || stripes.hasPerm('ui-quick-marc.quick-marc-holdings-editor.view'));
